...
namespace Survivebest.Core
{
    public static class LifeActivityCatalog
    {
        ...
        private static readonly string[] WebChatActivities = { "Late-night web chat with friends", "Ask for tech help in a community room", "Moderate a heated hobby chat", "Plan a game night in server chat", "Join a career networking thread", "Share a progress update in support chat", "Help a new member with setup issues", "Host a Q&A in your creator room", "Patch relationship tension in direct chat", "Quietly lurk and read the room vibe", "Swap deep talking topics about regret and growth", "Run a co-parenting schedule sync call", "Group call planning a neighborhood bike rally" };
        private static readonly string[] MiniGameActivities = { "Puzzle speedrun challenge", "Rhythm streak warmup", "Co-op survival mini run", "Typing duel match", "Retro arcade score chase", "Tower-defense quick round", "Card strategy showdown", "Platform challenge gauntlet", "Trivia blitz session", "Boss-rush practice run", "Playground tag tournament", "Water balloon capture-the-flag", "Bike obstacle course race", "Remote-control car relay race", "Swing timing challenge showdown" };
        ...
        private static readonly string[] HumanExperienceMoments = { "late-night grocery run", "mall wandering with no plan", "thrift-store luck streak", "yard-sale find", "group-chat debate over dinner", "waiting-room small talk", "school pickup scramble", "weekend Costco run", "laundry-room negotiation", "parking-lot car snack reset", "make ramen at 1am", "forgotten birthday spiral", "power outage dinner", "loose pet scare on the block", "crowded splash-pad water fight", "teaching a child to pedal their first bike", "waiting your turn for the playground swings", "core memory formed during a family road trip" };
        ...
        private static readonly Dictionary<LifeStage, string[]> OutfitStylesByLifeStage = new()
        {
            ...
            { LifeStage.Toddler, new[] { "Playdate Outfit", "Story Time Pajamas", "Park Explorer Set", "Tiny Streetwear", "Mini Formalwear", "Splash-Pad Outfit", "Playground Swing Set Fit" } },
            { LifeStage.Child, new[] { "School Casual", "Sport Uniform", "Birthday Party Outfit", "Rainy Day Layers", "Youth Streetwear", "Family Photo Look", "Water Balloon Team Colors", "Bike Trail Adventure Fit" } },
            ...
            { LifeStage.Teen, new[] { "Teen Streetwear", "Study Session Layers", "Date Night Fit", "School Formalwear", "Gig Outfit", "Athleisure", "Skate/Bike Park Fit", "Pool Party Layered Set" } },
            { LifeStage.YoungAdult, new[] { "Brunch Casual", "Office Workwear", "Gym Athleisure", "Nightlife Look", "Festival Fit", "Apartment Cozywear", "Creator Streetwear", "Road Trip Utility Set", "Water Fight Athletic Set" } },
            { LifeStage.Adult, new[] { "Workwear", "Business Formal", "Weekend Casual", "Parent-on-the-go Utility", "Dinner Date Look", "Outdoor Layers", "Loungewear", "Family Bike Ride Fit", "Playground Activewear" } },
        ...
        public static IReadOnlyList<string> GetFamilyMoments() => FamilyMoments;
        public static IReadOnlyList<string> GetDatingActivities() => DatingActivities;
        public static IReadOnlyList<string> GetMiniGameActivities() => MiniGameActivities;
        public static IReadOnlyList<string> GetHumanExperienceMoments() => HumanExperienceMoments;
