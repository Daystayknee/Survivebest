...
namespace Survivebest.UI
{
    ...
    public class GameplayScreenController : MonoBehaviour
    {
        ...
        private void HandleVitalityChanged(float value) => SetBar(healthBar, value);
        private void HandleEnergyChanged(float value) => SetBar(staminaBar, value);
        private void HandleHungerChanged(float value) => SetBar(hungerBar, value);
        private void HandleHydrationChanged(float value) => SetBar(thirstBar, value);
        private void HandleMoodChanged(float value) => SetBar(socialBar, value);
