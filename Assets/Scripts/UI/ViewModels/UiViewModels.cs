...
namespace Survivebest.UI.ViewModels
{
    ...
    [Serializable] public class CharacterCreatorViewModel { public string DisplayName; public int Age; public string TraitSummary; }
        [Serializable] public class CharacterCreatorDashboardViewModel { public string ActiveTab; public string HairTextureFilter; public string HairLengthFilter; public string FacialHairFilter; public int AvailableStyles; public int SavedPresetCount; }
