...
- Added `CharacterCreatorDashboardController` for modern paper-doll dashboard flow (Appearance/Genetics/Face/Body/Traits/Clothing tabs, filter-driven style cards, swatch colors, advanced sliders, preview rotate/zoom/drag, background switching, 2D orthographic focus modes for full body vs face/body closeups, randomize, and preset save/load hooks).
